...
public class RequestHTTPGet3 {
    private static String apiKey = ReadProperties.loadProperty("API_KEY");

    public static String requestHTTPGetV3() {
        ...
        String responseServer = "nothing";
        try {
            responseServer = makeAPICall(uri, parameters);
        ...
        // обработаем JSON ответ сервера
        ResponseParser responseParser = new ResponseParser();
        String filteredResponse = responseParser.startParser(responseServer);
